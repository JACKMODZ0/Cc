...
def select_random_cookie_pair():
    ...
    if not pairs:
        ...
        SELECTED_COOKIE_PAIR = {'file1': 'cookies_1-1.txt', 'file2': 'cookies_1-2.txt', 'id': 'fallback'}
        return SELECTED_COOKIE_PAIR
    
    # Select random pair
    selected_pair = random.choice(pairs)
    SELECTED_COOKIE_PAIR = selected_pair
    print(f"🎲 Selected cookie pair: {selected_pair['id']} ({selected_pair['file2']}, {selected_pair['file2']})")
